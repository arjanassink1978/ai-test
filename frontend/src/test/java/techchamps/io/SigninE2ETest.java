...
public class SigninE2ETest {
    ...
    void testSignupWithExistingUsernameShowsError() {
        ...
        assertTrue((Boolean) page.locator("input[name=\"username\"]").evaluate("el => el.classList.contains('border-red-500')"));
    }
    ...
    void testSignupWithExistingEmailShowsError() {
        ...
        assertTrue((Boolean) page.locator("input[name=\"email\"]").evaluate("el => el.classList.contains('border-red-500')"));
    }
